// ====================================================
//  VERSION: 007-index
//  FILE: components/007-CodeBlock.tsx
// ====================================================

import React, { useState, useEffect } from 'react';
import { CopyIcon, CheckIcon, PreviewIcon, CodeIcon, FullScreenIcon, ExitFullScreenIcon } from './007-icons';
...
// New function for creating a unified string for the code view
    ...
    <div className="fixed inset-0 z-50 bg-gray-900 flex flex-col">
        <header className="flex-shrink-0 bg-gray-800 p-2 flex justify-end">
            <button
                ...
                className="flex items-center text-gray-400 hover:text-white transition-colors duration-200 p-2 rounded-md bg-gray-700 hover:bg-gray-600"
