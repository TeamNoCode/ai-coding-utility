...
export const PreviewIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639l4.43-6.112a1.011 1.011 0 011.581-.023l2.83 3.665a1.01 1.01 0 001.54 0l2.83-3.665a1.012 1.012 0 011.582.023l4.43 6.112a1.012 1.012 0 010 .639l-4.43 6.112a1.012 1.012 0 01-1.581.023l-2.83-3.665a1.01 1.01 0 00-1.54 0l-2.83 3.665a1.012 1.012 0 01-1.582-.023L2.036 12.322z" />
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5a6.375 6.375 0 00-6.375 6.375c0 1.623.59 3.112 1.58 4.293a.75.75 0 001.125-.133 6.375 6.375 0 001.1-2.932.75.75 0 01.444-.687 6.375 6.375 0 016.333-1.043.75.75 0 00.56-.285 6.375 6.375 0 00.32-6.622A6.375 6.375 0 0012 4.5z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 19.5a6.375 6.375 0 01-6.375-6.375c0-1.623.59-3.112 1.58-4.293a.75.75 0 011.125-.133 6.375 6.375 0 011.1 2.932.75.75 0 00.444.687 6.375 6.375 0 006.333-1.043.75.75 0 01.56.285 6.375 6.375 0 01.32 6.622A6.375 6.375 0 0112 19.5z" />
