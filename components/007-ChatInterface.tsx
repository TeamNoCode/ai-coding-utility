// ====================================================
//  VERSION: 007-index
//  FILE: components/007-ChatInterface.tsx
// ====================================================
...
import { startChatSession } from '../services/007-geminiService';
import { supabase } from '../services/007-supabaseClient';
import SidePanel from './007-SettingsPanel';
import MessageComponent, { parseContent, ParsedCodePart } from './007-Message';
import ThinkingMessage from './007-ThinkingMessage';
import CodeBlock from './007-CodeBlock';
import { SendIcon, ChevronDoubleRightIcon, CloseIcon, SparklesIcon, BrainCircuitIcon, PreviewIcon, UndoIcon, RedoIcon, PlusIcon, XCircleIcon } from './007-icons';
import { DEFAULT_LANGUAGE, DEFAULT_TEMPERATURE } from '../007-constants';
