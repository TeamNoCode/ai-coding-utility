...
export const AiIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M19.5,12A7.5,7.5,0,0,0,12,4.5A7.5,7.5,0,0,0,4.5,12A7.5,7.5,0,0,0,12,19.5A7.5,7.5,0,0,0,19.5,12M12,2A10,10,0,0,1,22,12A10,10,0,0,1,12,22A10,10,0,0,1,2,12A10,10,0,0,1,12,2M12,6A1.5,1.5,0,0,1,13.5,7.5A1.5,1.5,0,0,1,12,9A1.5,1.5,0,0,1,10.5,7.5A1.5,1.5,0,0,1,12,6M7,12A1.5,1.5,0,0,1,8.5,13.5A1.5,1.5,0,0,1,7,15A1.5,1.5,0,0,1,5.5,13.5A1.5,1.5,0,0,1,7,12M17,12A1.5,1.5,0,0,1,18.5,13.5A1.5,1.5,0,0,1,17,15A1.5,1.5,0,0,1,15.5,13.5A1.5,1.5,0,0,1,17,12M12,15A1.5,1.5,0,0,1,13.5,16.5A1.5,1.5,0,0,1,12,18A1.5,1.5,0,0,1,10.5,16.5A1.5,1.5,0,0,1,12,15Z" />
  </svg>
);
...
export const CopyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 01-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 011.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 00-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375V9.375m0-3.75c.621 0 1.125.504 1.125 1.125v1.5c0 .621-.504 1.125-1.125 1.125H9.375a1.125 1.125 0 01-1.125-1.125v-1.5c0-.621.504-1.125 1.125-1.125h3.75z" />
    </svg>
);
...
export const BrainCircuitIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2a9.5 9.5 0 0 1 9.5 9.5c0 1.96-.59 3.8-1.59 5.34l.004.008c.036.064.07.13.102.198.052.11.096.223.136.338.077.22.14.448.192.68.045.202.08.408.106.618.026.21.04.423.05.64.01.21.014.42.015.632a3.5 3.5 0 0 1-3.5 3.5c-1.37 0-2.56-.78-3.13-1.91a.5.5 0 0 0-.94.02A3.5 3.5 0 0 1 9.5 21a3.5 3.5 0 0 1-3.5-3.5c0-.9.33-1.72.88-2.36a.5.5 0 0 0-.024-.712A9.46 9.46 0 0 1 2.5 11.5a9.5 9.5 0 0 1 9.5-9.5zm0 2a7.5 7.5 0 0 0-7.5 7.5c0 3.12 1.9 5.82 4.58 6.89a.5.5 0 0 0 .42-.49V17.5a.5.5 0 0 0-.5-.5h-2a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-.5-.5h-2a.5.5 0 0 0-.5.5v.9a.5.5 0 0 0 .42.49A7.5 7.5 0 0 0 19.5 11.5a7.5 7.5 0 0 0-7.5-7.5zm0 3a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z"/>
    </svg>
);
...
export const RegenerateIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.495 7.545A8.25 8.25 0 0 0 4.5 12a8.25 8.25 0 0 0 13.065 5.825m1.485-5.825a8.25 8.25 0 0 1-14.55 0" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M18 4.5v4.5h-4.5" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 19.5v-4.5h4.5" />
    </svg>
);
