// ====================================================
//  VERSION: codr-src
//  FILE: src/components/codr-src-SettingsPanel.tsx
// ====================================================

import React, { useState, useEffect } from 'react';
import type { Session } from '@supabase/supabase-js';
import { supabase, supabaseEnabled } from '../services/codr-src-supabaseClient';
import { SUPPORTED_LANGUAGES } from '../codr-src-constants';
import { ChatHistory } from '../codr-src-types';
import { UserIcon, LogoutIcon, ChevronDoubleLeftIcon, ChevronDownIcon, ChevronUpIcon, GoogleIcon } from './codr-src-icons';
