// ====================================================
//  VERSION: codr-src
//  FILE: src/components/codr-src-Message.tsx
// ====================================================

import React from 'react';
import type { Session } from '@supabase/supabase-js';
import { Message as MessageType, MessageRole } from '../codr-src-types';
import { UserIcon, AiIcon, PreviewIcon, BrainCircuitIcon, RegenerateIcon, CopyIcon, BookmarkIcon } from './codr-src-icons';
import CodeBlock from './codr-src-CodeBlock';
import { supabaseEnabled } from '../services/codr-src-supabaseClient';
